    ...
    <div className="register-container">
      ...
      <form className="register-form" onSubmit={handleSubmit}>
        <div className="form-row">
          ...
          <input type="text" name="member2" placeholder="Member-2" value={formData.member2} onChange={handleChange} required />
        </div>
        <div className="form-row">
          <input type="text" name="member3" placeholder="Member-3" value={formData.member3} onChange={handleChange} required />
