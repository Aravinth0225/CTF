...
const networkChallenges = [
  { name: "0x20", points: "50 points", description: "HTTP-packets", difficulty: "EASY" },
  { name: "0x21", points: "50 points", description: "Be a Detective and Find the Secrets", difficulty: "EASY" },
];
